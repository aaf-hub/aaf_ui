...
const teamData = {
  farhan: {
    ...
    bio: [
      ...
      "Before co-founding AFANA, Farhan worked as a private veterinary surgeon conducting clinical services for farms and pet owners, and welfare inspections at abattoirs and markets. He combines clinical veterinary experience with quantitative research and policy translation to drive practical, evidence-based animal welfare outcomes across Nigeria and the wider region.",
