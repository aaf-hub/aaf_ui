  ...
  farhan: {
    ...
    bio: [
     "Farhan Rhidor Akorede is a veterinary surgeon, research scientist, and Co-Founder & Research Lead at Afana Animal Futures, where he leads the organisation's research on animal welfare, One Health, and sustainable livestock systems across Nigeria. He holds a DVM from the University of Ilorin and an MVSc in Veterinary Pharmacology at Usmanu Danfodiyo University, Sokoto.",
      "Farhan has led grant-funded, multiregional studies on farmers' behavioural drivers for welfare in cattle production (supported by Welttierschutzstiftung) and on stakeholder awareness of welfare during livestock transport and in markets (supported by the Humane Slaughter Association), alongside earlier work on hen welfare and cage-free sourcing with the One Health and Development Initiative. His research has been published in reputable journals including the Animal Welfare Journal (Cambridge Core), Medicine in Microecology (Elsevier) and PLoS One, and he serves as a peer reviewer for journals like Discover Public Health and BMC Agriculture.", 
      "Before co-founding Afana, Farhan worked as a Private veterinary surgeon conducting private clinical services for farms, pet owners, and welfare inspections at abattoirs and markets. He was a research associate with Tailored Food (Canada), Alliance for Sustainable Livestock, contributing to food systems and livestock research across African countries. He combines clinical veterinary experience with quantitative and qualitative research and policy translation to drive practical, evidence-based animal welfare outcomes across Nigeria and the wider region.",
...
islamiyah: {
  ...
  bio: [
    ...
    "Islamiyyah is passionate about improving animal health and welfare through early diagnosis, preventive care, and modern technology including spatial design and digital tools for veterinary education and diagnostic precision. Combined with her international student leadership as a Global Ambassador for the Standing Committee on Veterinary Education (SCOVE) with the International Veterinary Students' Association (IVSA), she brings solid lab skills, clear communication, and a practical, welfare-conscious approach to veterinary research."
     "In her spare time, she Reads diverse perspective writings on Medium, Sleep, and watches horror movies"
  ]
}
};
